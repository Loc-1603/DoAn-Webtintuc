            ...
            <div class="col-lg-9">
                ...
                @if($tin->Hinh)
                    <div style="width: 100%; aspect-ratio: 16/9; overflow: hidden;">
                        <img class="img-fluid" src="upload/tintuc/{{$tin->Hinh}}" alt="{{$tin->TieuDe}}" style="width: 100%; height: 100%; object-fit: cover; object-position: center;">
                    </div>
                @endif
                <!-- Date/Time -->
                @if($tin->created_at)
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-md-5">
                                ...
                                <a href="chi-tiet/{{$tlq->id}}/{{$tlq->TieuDeKhongDau}}.html">
                                    <div style="width: 100%; aspect-ratio: 16/9; overflow: hidden;">
                                        <img class="img-fluid" src="upload/tintuc/{{$tlq->Hinh}}" alt="{{$tlq->TieuDe}}" style="width: 100%; height: 100%; object-fit: cover; object-position: center;">
                                    </div>
                                </a>
                                @endif
                            </div>
                                ...
                                <div class="col-md-5">
                                    @if($tm->Hinh)
                                        <a href="chi-tiet/{{$tm->id}}/{{$tm->TieuDeKhongDau}}.html">
                                            <div style="width: 100%; aspect-ratio: 16/9; overflow: hidden;">
                                                <img class="img-fluid" src="upload/tintuc/{{$tm->Hinh}}" alt="{{$tm->TieuDe}}" style="width: 100%; height: 100%; object-fit: cover; object-position: center;">
                                            </div>
                                        </a>
                                    @endif
                                </div>
